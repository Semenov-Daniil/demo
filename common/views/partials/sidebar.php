...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="index" class="logo logo-dark text-decoration-none">
            <span class="logo-sm fs-3 fw-bolder">
                D
            </span>
            <span class="logo-lg fs-3 fw-bolder">
                Demo
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index" class="logo logo-light text-decoration-none">
            <span class="logo-sm fs-3 fw-bolder">
                D
            </span>
            <span class="logo-lg fs-3 fw-bolder">
