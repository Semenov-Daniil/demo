...
<div class="col-md-8 col-lg-6 col-xl-5">
    <div class="card mt-4 card-bg-fill">
        ...
        <div class="card-body p-4">
            <div class="row g-0 mt-2 align-items-center justify-content-center">
                <div class="logo-wrap col-3">
                    <svg class="logo-svg" id="_Слой_2" data-name="Слой 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1500 1500">
                        <g id="_1" data-name="1">
                            <g>
                ...
                <h3 class="logo-text col-sm-9 col-12 mt-sm-0 mt-3">Колледж судостроения и прикладных технологий</h3>
            </div>
            <div class="p-2 mt-3">
                <?php Pjax::begin([
                    'id' => 'pjax-login'
